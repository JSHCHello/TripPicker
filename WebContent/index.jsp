...
<!-- 검색조건 -->
  ...
  <div class="intro intro-carousel">
    <div id="carousel" class="owl-carousel owl-theme">
                ...
                <div class="col-lg-8">
                  <div class="intro-body">
                    <h1 class="intro-title mb-4">
                      <span class="color-b">새해 첫 </span> 여행
                      <br> 함께 즐기자!</h1>
                    <p class="intro-subtitle intro-price">
                      <a href="#"><span class="price-a">2022년 새해 복 많이 받으세요</span></a>
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="container">
              <div class="row">
                <div class="col-lg-8">
                  <div class="intro-body">
                    <h1 class="intro-title mb-4">
                      <span class="color-b">겨울 </span> 감성
                      <br> 분위기 가득한 여행</h1>
                    <p class="intro-subtitle intro-price">
                      <a href="#"><span class="price-a">겨울 테마</span></a>
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div class="carousel-item-a intro-item bg-image" style="background-image: url(img/slide-3.png)">
        <div class="overlay overlay-a"></div>
        <div class="intro-content display-table">
          <div class="table-cell">
            <div class="container">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-12 col-md-4 section-md-t3">
          <div class="widget-a">
            <div class="w-header-a">
              <h3 class="w-title-a text-brand">트립피커</h3>
            </div>
            <div class="w-body-a">
              <div class="w-body-a">
                <ul class="list-unstyled">
                  <li class="item-list-a">
                    <i class="fa fa-angle-right"></i> <a href="#">코스짜기</a>
                  </li>
                  <li class="item-list-a">
                    <i class="fa fa-angle-right"></i> <a href="#">여행장소</a>
                  </li>
                  <li class="item-list-a">
                    <i class="fa fa-angle-right"></i> <a href="#">숙박/교통</a>
                  </li>
                  <li class="item-list-a">
        ...
        <div class="col-sm-12 col-md-4 section-md-t3">
          <div class="widget-a">
            <div class="w-header-a">
              <h3 class="w-title-a text-brand">고객센터</h3>
            </div>
            <div class="w-body-a">
              <ul class="list-unstyled">
                <li class="item-list-a">
                ...
                <li class="item-list-a">
                  <i class="fa fa-angle-right"></i> <a href="#">1:1문의</a>
                </li>
                <li class="item-list-a">
